...
<Html>
<Head>
<Title>P4Web.FreeBSD.org - //depot/projects/soc2010/ext4fs/src/sys/fs/ext4fs/inode.h</Title>
...
<Form method="POST" enctype="application/x-www-form-urlencoded" action="inode.h?ac=152">
<td class="pathField">
<Input type=text name="goField" value="//depot/projects/soc2010/ext4fs/src/sys/fs/ext4fs/inode.h" size="92">
&nbsp;
...
<noscript>
<td>
<Form method="POST" enctype="application/x-www-form-urlencoded" action="inode.h?ac=84">
</td>
</noscript>
<td width="1">
...
<td width="25">
<a href="inode.h?ac=22&fl=-i"><img src="/branchHistOffIcon?ac=20" height="25" width="25" border="0" alt="Show branching history" title="Show branching history"></a>
</td>
<td valign="middle" align="center" width="7">
...
<td width="30">
<a href="/@md=d&cd=//depot/projects/soc2010/ext4fs/src/sys/fs/ext4fs/&cdf=//depot/projects/soc2010/ext4fs/src/sys/fs/ext4fs/inode.h&ra=s&rg=b@//filebrowser?ac=21" class="nav_link"><img src="/helpIcon?ac=20" height="25" width="25" border="0" alt="Help" title="Help"></a>
</td>
</tr>
</Table>
</td>
...
<tr bgcolor="#EEEEEE">
<td>
<Form method="POST" enctype="application/x-www-form-urlencoded" action="inode.h?ac=204">
</td>
<td nowrap>
Go to:
<Select name="type">
...
<img src="/clearpixelIcon?ac=20" height="1" width="5" border="0" alt="" title=""></td>
<td>
<a href="//127.0.1.3:2083/@rev1=head@//depot/projects/soc2010/ext4fs/src/sys/fs/ext4fs/inode.h" title="Open head revision in browser">#2</a>
</td>
<td>
<img src="/clearpixelIcon?ac=20" height="1" width="30" border="0" alt="" title=""></td>
</tr>
...
<tr>
<td>
<Form method="POST" enctype="application/x-www-form-urlencoded" action="inode.h?ac=191" name="filelogForm">
...
<tr>
<td valign="bottom">
<nobr><img src="/clearpixelIcon?ac=20" height="1" width="28" border="0" alt="" title=""><a href="inode.h?ac=64&rev1=2" title="View revision text"><img src="/showtextsmallIcon?ac=20" height="18" width="25" border="0" alt="View revision text" title="View revision text"></a>
<a href="inode.h?ac=19&rev1=1&rev2=2"><img src="/rundiffprevsmallIcon?ac=20" height="18" width="25" border="0" alt="Diff rev #1 vs. rev #2" title="Diff rev #1 vs. rev #2"></a></nobr>
</td>
...
<tr class="alt_row">
<td valign="bottom">
<nobr><img src="/clearpixelIcon?ac=20" height="1" width="28" border="0" alt="" title=""><a href="inode.h?ac=64&rev1=1" title="View revision text"><img src="/showtextsmallIcon?ac=20" height="18" width="25" border="0" alt="View revision text" title="View revision text"></a></nobr>
</td>
<td nowrap class="top_line">
add</td>
</tr>
...
<a href="/depot/projects/soc2010/ext4fs/src/sys/fs/ext4fs/inode.h?ac=22">Permalink</a>
</td>
<td width="5">
<img src="/clearpixelIcon?ac=20" height="1" width="5" border="0" alt="" title=""></td>
</tr>
